...
export default function Column({ source, items, subFilters, subCounts, readIds, bookmarkIds, loading, initialLoaded, searchQuery, onRead, onBookmark, onSubFilterToggle }: Props) {
  ...
  return (
    <div className="flex flex-col flex-1 min-w-0 overflow-hidden" style={{ borderRight: '1px solid var(--border)' }}>
      ...
      {/* ── Column header ── */}
      <div className="flex-shrink-0" style={{ backgroundColor: 'var(--bg)', borderBottom: `2px solid ${bd}` }}>
        ...
        {/* Sub-feed chips — always rendered for uniform header height */}
      ...
      {/* ── Scrollable body ── */}
      <div className="flex-1 overflow-y-auto" style={{ scrollbarWidth: 'thin', scrollbarColor: `${bd} transparent` }}>
